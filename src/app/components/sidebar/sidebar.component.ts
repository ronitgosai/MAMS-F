...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    role: [environment.adminRole, environment.rawMaterialRole],
  },
  {
    path: "/inventory",
    title: "Inventory",
    icon: "fas fa-prescription-bottle",
    role: [environment.adminRole,environment.inventoryRole],
  },
  {
  ...
  },
  {
    ...
    title: "Products",
    icon: "fas fa-vial",
    role: [environment.adminRole,environment.productRole],
  },
  {
    path: "/stock",
    title: "Stock",
    icon: "fas fa-warehouse",
    role: [environment.adminRole,environment.stockRole],
  },
  {
    path: "/sell",
    title: "Sell",
    icon: "fas fa-receipt",
    role: [environment.adminRole,environment.sellRole],
  },
  {
    path: "/customer",
    title: "Customers",
    icon: "fas fa-user-friends",
    role: [environment.adminRole,environment.customerRole],
  },
  {
    path: "/user",
    title: "User",
